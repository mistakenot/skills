...
## Prompt Exampmles from ACE paper

https://arxiv.org/html/2510.04618v3#A6

Reflector Prompt example
...
{{
  ...
  "error_identification": "The pagination logic used an arbitrary fixed limit instead of continuing until all pages were returned.",

  "root_cause_analysis": "The agent took a cautious approach with a fixed upper bound to avoid infinite loops, but this prevented complete data collection when the actual data exceeded the arbitrary limit.",
