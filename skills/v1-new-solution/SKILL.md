...
10. **Hard-stop** -- present the completed solution.md and context.md to the user. Do NOT proceed to the plan stage. Tell them: "Review solution.md and context.md. When ready, run `/v1-new-plan` to continue."
