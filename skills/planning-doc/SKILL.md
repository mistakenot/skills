...
```bash
curl -fsSL https://cdn.jsdelivr.net/gh/mistakenot/skills@pd-v0.5.0/pd-components/dist/llms.txt
```
...
it names (`pd-v0.5.0`), never `@main`. To move to a newer component
...
`https://cdn.jsdelivr.net/gh/mistakenot/skills@pd-v0.5.0/pd-components/dist/pd.min.js` (defer).
