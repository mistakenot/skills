...
Present both context.md and plan.md to the user. Do NOT proceed to execution or commit. Tell them: "Review context.md and plan.md. When ready, run `/v1-review-task` for a review or `/v1-commit-task` to finalize."
