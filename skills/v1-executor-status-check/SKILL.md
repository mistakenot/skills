...
- **Suggested next step**:
  - completed + PR open -> `/v1-address-feedback`
  - feedback resolved -> `/v1-complete-task`
  - PR merged -> `/clear`
...
|------|------|-------------|--------|---------|--------------|-----------|
| 0    | 434  | Add widget  | completed | 8%  | PR #87 created | /v1-address-feedback |
