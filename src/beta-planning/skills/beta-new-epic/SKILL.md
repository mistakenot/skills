...
9. **Hard-stop** -- present the completed `epic-$ID-$NAME.html` to the user. Do NOT start planning tasks. Tell them: "Review the epic file. When ready, plan the first task with `/{{ skill:beta-new-task }}` and reference this epic."
