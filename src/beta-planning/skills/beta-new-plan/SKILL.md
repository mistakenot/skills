---
name: beta-new-plan
description: "Writes the Plan tab and backfills AC traceability for a beta task. Use when 'beta plan', 'beta new plan', 'write beta plan', or after beta solution is approved. Not for markdown plans (use new-plan instead)."
---
