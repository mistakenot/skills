...
```bash
curl -fsSL https://cdn.jsdelivr.net/gh/mistakenot/skills@{{ pd-version }}/pd-components/dist/llms.txt
```
...
`https://cdn.jsdelivr.net/gh/mistakenot/skills@{{ pd-version }}/pd-components/dist/pd.min.js` (defer).
