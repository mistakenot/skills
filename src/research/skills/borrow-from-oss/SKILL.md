...
This is the external-facing mirror of {{ skill:learning-diary }}: that skill mines *your own* history for what you learned; this one mines *other people's* repos for what you could steal.
