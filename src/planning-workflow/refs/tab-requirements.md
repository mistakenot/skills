...
The Requirements tab captures the problem, goals, and scope. It is the first tab in `plan.html`, created by `{{ skill:new-task }}`.
...
4. **Open Questions** (id: `open-questions`) — Checkbox list of unresolved questions. Mark answered ones with the answer.
