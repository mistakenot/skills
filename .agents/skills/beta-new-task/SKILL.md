...
9. **Hard-stop** -- present the completed plan.html to the user. Do NOT proceed to the solution stage. Tell them: "Review plan.html. When ready, run `/beta-new-solution` to continue."
