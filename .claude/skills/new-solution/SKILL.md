...
12. **Hard-stop** -- present the completed Verification and Solution tabs to the user. Do NOT proceed to the plan stage. Tell them: "Review the Verification and Solution tabs. When ready, run `/new-plan` to continue."
