...
if [[ -z "$MODULE" ]]; then
  ...
  case "$MODULE" in
    planning-workflow)
      SKILLS="new-epic,new-task,new-solution,new-plan,new-task-quick,review-task,request-codex-review,request-claude-review,request-grok-review,request-council-review,resolve-comments,commit-task,execute-task,delegate-task,delegate,status-report,address-feedback,complete-task,code-review,task-feedback-analyser"
      ;;
    ideation)
